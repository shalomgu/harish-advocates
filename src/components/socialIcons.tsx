// Shared social-network glyphs reused by the back cover and the floating
// quick-contact bar. Keep the path data here so both stay in sync.
export type SocialIcon = 'instagram' | 'facebook' | 'whatsapp' | 'linkedin'

export const socialIcons: Record<SocialIcon, JSX.Element> = {
  instagram: (
