...
const he: SiteContent = {
  ...
  media: {
    ...
    videos: {
      ...
      items: [
        {
          type: 'link',
          url: 'https://103fm.maariv.co.il/programs/media.aspx?ZrqvnVq=EMFGKH&c41t4nzVQ=EF',
          label: 'ראיון ברדיו 103FM – הצעת חוק לעידוד יצור מזון לחולי צליאק',
          icon: 'radio',
        },
      ],
    },
  ...
  contact: {
    ...
    phone: {
      ...
      titleMobile: '📞 סלולרי',
      tel: '037528111',
      telDisplay: '03-7528111',
      mobile: '0522778848',
      mobileDisplay: '052-2778848',
    },
...
const en: SiteContent = {
    ...
    blocks: [
      {
        ...
        intro:
          'A real estate transaction is often the largest investment of one\u2019s life. Adv. Harish provides full, professional guidance from the start of the transaction to its completion \u2014 including due diligence, negotiation and registration.',
        items: [
  ...
  tips: {
    ...
    videos: {
      ...
      items: [
        { type: 'video', url: asset('monopol.mp4'), label: 'Monopoly' },
        { type: 'video', url: asset('lior-likes.mp4'), label: 'Lior Recommends' },
        { type: 'video', url: asset('will.mp4'), label: 'Wills' },
        { type: 'video', url: asset('will-diy.mp4'), label: 'Wills \u2013 Do It Yourself?' },
        { type: 'video', url: asset('yipuy-koach-mitmashech.mp4'), label: 'Enduring Power of Attorney' },
        { type: 'video', url: asset('copy-rights.mp4'), label: 'Copyright' },
      ],
    },
    articles: {
      ...
      items: [
        ...
        {
          title: 'The Legal Guide for Apartment Landlords (Carousel)',
          thumbnail: asset('renters-guide.png'),
          images: [
            asset('renters-slide-1.png'),
            asset('renters-slide-2.png'),
      ...
      items: [
        {
          type: 'link',
          url: 'https://103fm.maariv.co.il/programs/media.aspx?ZrqvnVq=EMFGKH&c41t4nzVQ=EF',
          label: 'Interview on 103FM Radio \u2013 Bill to encourage production of food for celiac patients',
          icon: 'radio',
        },
      ],
    },
  ...
  backCover: {
    ...
    links: [
      { label: 'Instagram', href: 'https://www.instagram.com/liorharish_adv?igsh=MWNsc2FjcDVxanF0NQ==', icon: 'instagram' },
      { label: 'Facebook', href: 'https://www.facebook.com/share/1FsDPj9un9/', icon: 'facebook' },
      {
        label: 'WhatsApp',
        href: 'https://wa.me/972522778848?text=I%20would%20like%20to%20schedule%20a%20meeting',
        icon: 'whatsapp',
      },
      {
        label: 'LinkedIn',
...
export const pageTitles: Record<Locale, string[]> = {
  he: ['כריכה', 'אודות', 'הצוות', 'תחומי עיסוק', 'חשוב לדעת', 'מהתקשורת', 'צור קשר', 'כריכה אחורית'],
  en: ['Cover', 'About', 'The Team', 'Practice Areas', 'Good to Know', 'In the Media', 'Contact', 'Back Cover'],
}
